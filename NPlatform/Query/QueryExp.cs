...
namespace NPlatform.Query
{
    ...
    public class QueryExp : IQuery
    {
        ...
        /// </summary>
        [StringLength(1500)]
        public string LambdaExp { get; set; }
        ...
        public Expression<Func<T, bool>> GetExp<T>() where T : class
        {
            ...
            Expression<Func<T, bool>> exp = DynamicExpressionParser.ParseLambda<T, bool>(new ParsingConfig(), true, this.LambdaExp);
            return exp;
        }
        ...
        public IList<SelectSort> GetSelectSorts()
        {
            ...
            var sorts = System.Text.Json.JsonSerializer.Deserialize<List<SelectSort>>(this.SelectSorts);
            return sorts;
        }
        /// <summary>
        /// 创建表达式
