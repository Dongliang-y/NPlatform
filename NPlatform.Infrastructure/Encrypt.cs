namespace NPlatform.Infrastructure
{
    ...
    public class AES
    {
        ...
        public static string Decode(string decryptString, string decryptKey = "NPl!a.fo@r@m")
        {
        ...
        public static string Encode(string encryptString, string encryptKey = "NPl!a.fo@r@m")
        {
            ...
            var rst= Convert.ToBase64String(encryptedData);
            return $"NPLA|{rst}";
        }
