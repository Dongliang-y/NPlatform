...
namespace NPlatform
{
    ...
    public struct ObjectId : IComparable<ObjectId>, IEquatable<ObjectId>, IConvertible
    {
        ...
        public DateTime CreationTime
        {
            get
            {
                return BsonConstants.UnixEpoch.AddSeconds(Timestamp);
            }
        }
        ...
        {
            // don't throw ArgumentEmptyException if s is null
        ...
        {
            var secondsSinceEpoch = (long)Math.Floor(
                (BsonUtils.ToUniversalTime(timestamp) - BsonConstants.UnixEpoch).TotalSeconds);
